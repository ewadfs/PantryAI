...
CURATED: dict[str, tuple[float, float, float, float, float, float | None]] = {
    ...
    # ---- international staples (H Mart / Patel, Prompt 24-lite v2) --------
    "tofu": (144, 15.8, 4.3, 8.7, 2.3, 396.0),          # firm; 1 block≈14 oz
    "paneer": (265, 18.0, 6.0, 20.0, 0.0, None),
    "kimchi": (15, 1.1, 2.4, 0.5, 1.6, 150.0),
    "napa_cabbage": (16, 1.2, 3.2, 0.2, 1.2, 109.0),
    "daikon": (18, 0.6, 4.1, 0.1, 1.6, 338.0),
    "toor_dal": (343, 22.0, 63.0, 1.5, 15.0, 200.0),    # dry
    "moong_dal": (347, 24.0, 59.0, 1.2, 16.0, 200.0),
    "chana_dal": (364, 20.0, 60.0, 6.0, 17.0, 200.0),
    "urad_dal": (341, 25.0, 59.0, 1.6, 18.0, 200.0),
    "atta_flour": (340, 13.2, 72.0, 2.5, 10.7, 120.0),
    "besan": (387, 22.0, 58.0, 6.7, 11.0, 92.0),
    "jaggery": (383, 0.4, 98.0, 0.1, 0.0, 200.0),
    "soba": (336, 14.4, 74.6, 0.7, 0.0, 100.0),         # dry
    "udon": (130, 3.0, 27.0, 0.2, 1.5, None),           # fresh, by weight
    "rice_cake": (230, 4.0, 52.0, 0.3, 0.6, None),
}
