...
# Import models so their metadata is registered on Base.metadata for autogenerate.
from app import models  # noqa: F401,E402

config = context.config

# Inject the application's database URL, normalized to the async (asyncpg) driver.
