...
ROWS: list[tuple] = [
    ...
    ("paneer", "Paneer", "dairy",
     ...
     296.0, 20.0, 4.0, 22.0, 0.0, None, "package"),
    # --- dumplings ----------------------------------------------------------
